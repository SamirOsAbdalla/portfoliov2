        ...
        <div className="hero__wrapper">
            <section>
                <div>
                    ...
                    <div style={{ top: "27vh", left: "-20vw" }} className="cloud__wrapper .moveAnimationFour">
                        <div style={{ width: "50px", height: "50px", opacity: "0.3" }} className="cloud">
                            <Image fill alt="Cloud" src={cloudSvg} />
                        </div>
                    </div>
                    <div style={{ top: "47vh", left: "-10vw" }} className="cloud__wrapper moveAnimationThree">
                        <div style={{ width: "30px", height: "30px", opacity: "0.9" }} className="cloud">
                            <Image fill alt="Cloud" src={cloudSvg} />
                        </div>
                    </div>
                    <div style={{ top: "67vh", left: "-20vw" }} className="cloud__wrapper .moveAnimationFive ">
